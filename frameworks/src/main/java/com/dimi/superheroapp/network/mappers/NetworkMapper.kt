...
import com.dimi.superheroapp.model.SuperHero
import com.dimi.superheroapp.util.EntityMapper
import com.dimi.superheroapp.network.model.SuperHeroNetworkEntity
import javax.inject.Inject

class NetworkMapper
@Inject constructor() :
    EntityMapper<SuperHeroNetworkEntity, SuperHero> {
    ...
    override fun mapFromEntity(entity: SuperHeroNetworkEntity): SuperHero {
        return SuperHero(
            ...
            intelligence = if (entity.powerStats.intelligence == "null") 0 else Integer.parseInt(
